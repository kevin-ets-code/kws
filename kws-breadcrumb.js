...
// Recherche de l'élément avec la classe "breadcrumb-list"
  var breadcrumbList = document.querySelector(".kws-breadcrumb-list");
...
// Recherche des éléments avec la classe "breadcrumb-item"
    var breadcrumbItems = breadcrumbList.querySelectorAll(".kws-breadcrumb-item");

// Ajout des items au script JSON-LD
    breadcrumbItems.forEach(function(item, index) {
      var breadcrumbName = item.getAttribute("kws-breadcrumb-name");
